...
import com.anciar.stickyheader.MainActivity
import com.anciar.stickyheader.databinding.ViewStickyHeaderBinding

class StickyHeaderDecoration(private val adapter: MainActivity.SectionedListAdapter, root: View) :
    ItemDecoration() {
